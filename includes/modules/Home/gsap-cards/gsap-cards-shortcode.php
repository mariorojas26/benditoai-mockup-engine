...
function benditoai_gsap_cards_shortcode($atts) {
    ...
    $defaults = array(
        'title_1' => 'Crea tu visual base',
        'summary_1' => 'Empieza con una composicion clara para tu producto o modelo.',
        'content_1' => 'Define la direccion visual, el encuadre y el contexto para que cada imagen conserve una intencion comercial desde el primer paso.',
        'eyebrow_1' => 'Paso 01',
        'image_1' => 'assets/images/1crea.png',
        'alt_1' => 'Visual BenditoAI para crear una imagen base',

        'title_2' => 'Viste la escena con IA',
        'summary_2' => 'Ajusta estilo, outfit y actitud sin perder coherencia de marca.',
        'content_2' => 'La card activa se expande mientras la imagen entra desde abajo, mostrando el contenido que corresponde al estado visible del scroll.',
        'eyebrow_2' => 'Paso 02',
        'image_2' => 'assets/images/crea2.png',
        'alt_2' => 'Modelo generado con IA para una marca de moda',

        'title_3' => 'Publica contenido listo para vender',
        'summary_3' => 'Cierra con imagenes pulidas para tienda, anuncios y redes.',
        'content_3' => 'Cuando esta tercera card queda activa, el pin termina naturalmente y la pagina puede continuar hacia la siguiente seccion.',
        'eyebrow_3' => 'Paso 03',
        'image_3' => 'assets/images/crea3.png',
        'alt_3' => 'Imagen final lista para vender con BenditoAI',
    ...
    >
        <div class="benditoai-gsap-cards__pin">
            <div class="benditoai-gsap-cards__layout">
                ...
                <div class="benditoai-gsap-cards__steps" aria-label="Progreso de 3 pasos">
                    <?php foreach ($cards as $index => $card) : ?>
                        <span class="benditoai-gsap-cards__steps-tile<?php echo $index === 0 ? ' is-active' : ''; ?>">
